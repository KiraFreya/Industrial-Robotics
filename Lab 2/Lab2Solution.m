...
%% Question 1: Animate transform (Quad copter flying)
        function Question1()
            ...
            %1.9) Encode the steps 1.1-1.8 in a %for’ loop and use the 'fps' option 
            % in ‘tranimate’ to speed up the animation
            for i = 2:length(trSteps)
                ...
                % Use the text tool from Week 1 Lab to plot in the 
                % left hand corner the RPY - roll pitch yaw - and quaternion value of the orientation at each step
...
% Use these to generate a  model of the manipulator using the Robot Toolbox in MATLAB 
        function Question4()
			...
			% model
            % Each link is 1m long moves along x axis (a = 1, d= 0)
            ...
            % n is how many links there are in the robot
